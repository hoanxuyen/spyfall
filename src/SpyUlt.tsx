export const ElementTestIds = {
  ...
  modal: "spyModalID",
  modalBackdrop: "spyModalBackdropID",
  toggle: "spyToggleID",
};
export const FormLabelClass = "text-lg font-bold";
export const LocationsTagClass =
  "bg-slate-400 bg-opacity-50 rounded-md px-2 flex-grow-0 flex-shrink-0 flex gap-2 text-sm sm:text-base items-center font-bold";
